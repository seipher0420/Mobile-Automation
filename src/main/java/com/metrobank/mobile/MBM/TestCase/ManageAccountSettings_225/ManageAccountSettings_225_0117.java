...
/**
 * @Description
 * Manage Account Settings_225 01.17
 * Validation of function by tapping 'Go back' button in Account Setting - Passcode Modal with the code provided
 * @author JVP
 */

public class ManageAccountSettings_225_0117 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_225 01.17");
		...
		// TODO : Tap "Gob back" button and user should navigate back to account setting screen
		// TODO : Repeat steps to delete enrolled account up to Passcode Modal
			// TODO : Validate that new Passcode Modal displayed is empty
