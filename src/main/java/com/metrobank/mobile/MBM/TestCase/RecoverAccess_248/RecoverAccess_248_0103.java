...
/**
 * @Description
 * Recover Access_248 01.03
 * Validation of 'I forgot my password' option
 * @author testuser
 *
 */

public class RecoverAccess_248_0103 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_248 01.03");
