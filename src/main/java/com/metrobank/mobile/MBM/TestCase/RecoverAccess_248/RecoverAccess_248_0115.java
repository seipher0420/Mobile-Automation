...
/**
 * @Description
 * Recover Access_248 01.15
 * Submit entered username_not existing mbo user
 * @author testuser
 *
 */

public class RecoverAccess_248_0115 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_248 01.15");
		...
		// TODO : Populate field with invalid username
