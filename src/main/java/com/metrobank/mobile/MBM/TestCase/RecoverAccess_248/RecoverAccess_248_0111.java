...
/**
 * @Description
 * Recover Access_248 01.11
 * Navigation of Back Button to Recover Screen
 * @author testuser
 *
 */

public class RecoverAccess_248_0111 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_248 01.11");
