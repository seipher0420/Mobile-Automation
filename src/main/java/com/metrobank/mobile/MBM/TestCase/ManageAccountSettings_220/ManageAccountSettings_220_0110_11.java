...
/**
 * @Description
 * Manage Account Settings_220 01.08
 * Validation of success snack bar response upon successful verification of passcode and new account alias
 * @author JVP
 */

public class ManageAccountSettings_220_0110_11 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.08");
