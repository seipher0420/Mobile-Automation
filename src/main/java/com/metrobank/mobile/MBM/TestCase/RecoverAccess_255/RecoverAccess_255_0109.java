...
/**
 * @Description
 * Recover Access_255 01.09 
 * Validation of Contact number - Email with invalid special Character
 * @author testuser
 *
 */

public class RecoverAccess_255_0109 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_255 01.09");
		...
		// TODO : Enter email address with valid special character (sample&email@sample.com)
