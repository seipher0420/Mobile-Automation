...
/**
 * @Description
 * Manage Account Settings_225 01.28
 * Validation of Enrolling again the deleted valid account
 * @author JVP
 */

public class ManageAccountSettings_225_0120 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		// TODO : Enter invalid passcode (incomplete)
		// TODO : Tap 'Proceed' button and validate prompt modal error message
