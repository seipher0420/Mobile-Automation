...
public class MBM183_0103 extends MobileConnection{

	PropertyFileHandler property = new PropertyFileHandler(Locators.TESTDATA);

	@Test
	public void DashBoardViewDepositAccountOnly0103() throws IOException, InterruptedException{
		...
		logGeneration.generateReport("MBM 183 Enroll Screen button with no data enter 0103");
		...
		TestUtil.waitTime(3);
		enrollmentPage.ClickBackButton(driver);
		logGeneration.inputLogs(LogType.pass, "Click Back Button", null);
		TestUtil.waitTime(3);
