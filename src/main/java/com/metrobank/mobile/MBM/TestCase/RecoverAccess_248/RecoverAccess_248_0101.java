...
/**
 * @Description
 * Recover Access_248 01.01 
 * Validate Recover Access option
 * @author testuser
 *
 */

public class RecoverAccess_248_0101 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_248 01.01");
