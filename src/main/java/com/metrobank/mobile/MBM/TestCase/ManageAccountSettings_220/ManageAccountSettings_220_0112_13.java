...
/**
 * @Description
 * Manage Account Settings_220 01.12-14
 * 01.12 - Validation of response when User inputted an invalid passcode
 * 01.13 - Validation of 'Check Details' button in invalid passcode error message
 * @author JVP
 */

public class ManageAccountSettings_220_0112_13 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.12");
