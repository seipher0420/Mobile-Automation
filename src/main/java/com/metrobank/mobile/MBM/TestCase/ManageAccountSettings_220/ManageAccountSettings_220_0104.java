...
/**
 * @Description
 * Manage Account Settings_220 01.04
 * Validation of tapping the Cancel button in Passcode modal [verification screen] when no data/code inputted
 * @author JVP
 */

public class ManageAccountSettings_220_0104 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.04");
