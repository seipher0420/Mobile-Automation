...
/**
 * @Description
 * Login Enroll Deposit_189 01.09
 * Validation of error screen back button
 * @author testuser
 *
 */

public class Enroll_Deposit_189_0109 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Enroll Deposit_189 01.09");
...
//		myAccountsPage.clickEnrollBtn(driver, true);
		...
		// TODO : Click error screen - back button
		TestUtil.waitTime(1);
