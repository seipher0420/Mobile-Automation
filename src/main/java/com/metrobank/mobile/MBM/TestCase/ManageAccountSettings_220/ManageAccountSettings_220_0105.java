...
/**
 * @Description
 * Manage Account Settings_220 01.05
 * Validation of tapping the Cancel button in Passcode modal [verification screen] with inputted data/code
 * @author JVP
 */

public class ManageAccountSettings_220_0105 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.05");
