...
public class MBM183_1113 extends MobileConnection{

	PropertyFileHandler property = new PropertyFileHandler(Locators.TESTDATA);

	@Test
	public void DashBoardViewDepositAccountOnly0113() throws IOException, InterruptedException{
		...
		logGeneration.generateReport("MBM 183 Validation of required field with correct inputted data 0113");
		...
		String accountNumber = property.GetValue("AccountNumber_183113");
		String alias = property.GetValue("AccountAlias_183113");
