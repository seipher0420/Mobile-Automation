...
/**
 * @Description
 * Login Enroll Deposit_189 01.06 
 * Enroll account screen when account alias already is invalid format
 * @author testuser
 *
 */

public class Enroll_Deposit_189_0106 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Enroll Deposit_189 01.06");
		...
		if (myAccountsPage.isErrorAliasInvalidDisplayed(driver) == true) {
