...
/**
 * @Description
 * Recover Access_248 01.05
 * Validation of username or email field_Username
 * @author testuser
 *
 */

public class RecoverAccess_248_0105 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_248 01.05");
