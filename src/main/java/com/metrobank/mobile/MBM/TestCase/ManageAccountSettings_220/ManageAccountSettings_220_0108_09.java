...
/**
 * @Description
 * Manage Account Settings_220 01.09
 * Validation of function when tapping Proceed option (button) in Passcode modal [verification screen] with data/code inputted
 * @author JVP
 */

public class ManageAccountSettings_220_0108_09 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.09");
