...
/**
 * @Description
 * Login Enroll Deposit_189 01.02 
 * Enroll account screen when user entered an invalid account number
 * @author testuser
 *
 */

public class Enroll_Deposit_189_0102 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		String invalidAccountNumber = property.GetValue("invalidAccountNumber");
		String invalidAlias = property.GetValue("invalidAlias");
		
		// Setup Logger
		LogGeneration logGeneration = new LogGeneration();
		logGeneration.generateReport("Enroll Deposit_189 01.02");
		...
		// My Accounts Page
		myAccountsPage.inputAccountNumber(driver, invalidAccountNumber);
			logGeneration.inputLogs(LogType.info, 
				String.format("Input Account Number : {%s}", invalidAccountNumber),  null);
			TestUtil.waitTime(1);
			// Defect found ^
