...
/**
 * @Description
 * Manage Account Settings_225 01.16
 * Validation of function by tapping 'Cancel' button in Account Setting - Passcode Modal with the code provided
 * @author JVP
 */

public class ManageAccountSettings_225_0116 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_225 01.16");
