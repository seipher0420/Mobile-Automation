...
/**
 * @Description
 * Recover Access_255 01.02 
 * Validation of Contact number - Invalid email format (.com)
 * @author testuser
 *
 */

public class RecoverAccess_255_0101 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_255 01.02");
		...
		// TODO : Enter incomplete email (no '.com' symbol) and click submit
