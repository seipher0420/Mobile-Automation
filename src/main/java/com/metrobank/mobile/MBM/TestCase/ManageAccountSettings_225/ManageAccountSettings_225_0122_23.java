 ...
 * 01.22 - Validation of Account Setting - Passcode Modal function when user inputs a valid passcode
 * 01.23 - Validation of function when user's inputted passcode is successfully verified
 * @author JVP
 */

public class ManageAccountSettings_225_0122_23 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_225 01.22");
		...
		// TODO : Enter valid passcode
		// TODO : Tap 'Proceed' button and validate processing screen is displayed
		
			
		/* TC 01.12 */
		logGeneration.generateReport("Manage Account Settings_225 01.23");	
		// TODO : Validate redirect to 'My Accounts' Screen and a snack bar (account successfully deleted) is displayed
