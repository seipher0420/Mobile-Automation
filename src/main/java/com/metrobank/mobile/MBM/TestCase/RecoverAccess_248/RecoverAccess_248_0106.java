...
/**
 * @Description
 * Recover Access_248 01.06
 * Validation of username or email field_Email Address
 * @author testuser
 *
 */

public class RecoverAccess_248_0106 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_248 01.06");
		...
		// TODO : Tap 'I forgot my password'
			...
			// TODO : Populate field with email address
