...
/**
 * @Description
 * Manage Account Settings_220 01.03
 * Validation of tapping the back button in Passcode modal [verification screen]
 * @author JVP
 */

public class ManageAccountSettings_220_0103 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.03");
