...
public class MBM183_0104 extends MobileConnection{

	PropertyFileHandler property = new PropertyFileHandler(Locators.TESTDATA);

	@Test
	public void DashBoardViewDepositAccountOnly0105() throws IOException, InterruptedException{
		...
		logGeneration.generateReport("MBM 183 Enroll button when account number is blank and alias have data 0104");
		...
		String alias = property.GetValue("accountalias_18304");
		enrollmentPage.inputAccountAlias(driver, alias);
		logGeneration.inputLogs(LogType.info, "Input Account Alias: " + alias, null);
