...
/**
 * @Description
 * Login Enroll Deposit_189 01.10
 * Validation of error screen 'Check Details' button
 * @author testuser
 *
 */

public class Enroll_Deposit_189_0110 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Enroll Deposit_189 01.10");
...
//		myAccountsPage.clickEnrollBtn(driver, true);
		...
		// TODO : Click error screen - 'Check Details' button
		TestUtil.waitTime(1);
