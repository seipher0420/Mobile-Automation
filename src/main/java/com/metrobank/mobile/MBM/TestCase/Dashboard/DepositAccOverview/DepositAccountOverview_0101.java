...
public class DepositAccountOverview_0101 extends MobileConnection{

	PropertyFileHandler property = new PropertyFileHandler(Locators.TESTDATA);

	@Test
	public void DashBoardAccountOverview0101() throws IOException, InterruptedException{
		...
		logGeneration.generateReport("Dashboard Viewing of Enrolled Active Deposit Account List via Dashboard 0101");
