...
public class MBM183_0111 extends MobileConnection{

	PropertyFileHandler property = new PropertyFileHandler(Locators.TESTDATA);

	@Test
	public void DashBoardViewDepositAccountOnly0111() throws IOException, InterruptedException{
		...
		logGeneration.generateReport("MBM 183 Validation of Account Alias field when no data entered 0111");
		...
		String alias = property.GetValue("AccountAlias_183111");
		TestUtil.waitTime(2);
		...
		try{
			...
			logGeneration.inputLogs(LogType.pass, "Create an alias for your account error message is displayed", null);
		}catch(AssertionError e){
