...
public class MBM183_1117  extends MobileConnection{

	PropertyFileHandler property = new PropertyFileHandler(Locators.TESTDATA);

	@Test
	public void DashBoardViewDepositAccountOnly0117() throws IOException, InterruptedException{
		...
		logGeneration.generateReport("MBM 183 Validation of the Account Alias field when user enter a long alias 0117");
		...
		String accountNumber = property.GetValue("AccountNumber_183117");
		String alias = property.GetValue("AccountAlias_183117");
