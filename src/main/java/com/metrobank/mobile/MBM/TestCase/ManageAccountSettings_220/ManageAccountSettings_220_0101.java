...
/**
 * @Description
 * Manage Account Settings_220 01.01 
 * Validation of Passcode Modal [verification screen] after tapping Apply button with a Valid Inputted data
 * @author JVP
 */

public class ManageAccountSettings_220_0101 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Manage Account Settings_220 01.01");
