...
/**
 * @Description
 * Recover Access_255 01.01 
 * Validation of Contact number - Invalid email format(@)
 * @author testuser
 *
 */

public class RecoverAccess_255_0102 extends MobileConnection {
	...
	public void connectionMobile() throws InterruptedException, IOException{
		...
		logGeneration.generateReport("Recover Access_255 01.01");
		...
		// TODO : Enter wrong format of email (no '@' symbol) and click submit
