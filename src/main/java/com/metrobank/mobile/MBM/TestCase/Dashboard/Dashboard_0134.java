	...
	public void ViewingShortcutWidget() throws IOException, InterruptedException{
		...
		try {
			...
			logGeneration.inputLogs(LogType.fail,
					"Shortcut Widget SendMoney is not displayed", null);
		}
		...
		try {
			...
			logGeneration.inputLogs(LogType.fail,
					"Shortcut Widget MoveMoney is not displayed", null);
		...
		try {
			...
			logGeneration.inputLogs(LogType.fail,
					"Shortcut Widget LoadPrepaid is not displayed", null);
		...
		try {
			...
			logGeneration.inputLogs(LogType.fail,
					"Shortcut Widget OpenTimeDeposit is not displayed", null);
		...
		try {
			...
			logGeneration.inputLogs(LogType.fail,
					"Shortcut Widget PayBills is not displayed", null);
